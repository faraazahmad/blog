...
category: AI
tags: ['ai', 'knowledge']
cover: 'posts/knowledge-assistant-ai/attachments/knowledge_wizard.png'
---
...
![Indexes in Distributed databases](knowledge-assistant-ai/attachments/indexes_in_dist_db.png)
...
![Raft](knowledge-assistant-ai/attachments/raft.png)

## Under the hood

There's not a whole lot going on under the hood. The arhitecture for this is fairly simple:

![Kai architecture](knowledge-assistant-ai/attachments/kai_architecture.png)
...
![Mistral Models](knowledge-assistant-ai/attachments/mistral-models.png)
