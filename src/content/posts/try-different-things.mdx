...
category: Essays
tags: ['career', 'life']
cover: 'posts/try-different-things/attachments/different_things.png'
---
...
![Unreal Engine blueprints](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/f65984c9-013f-488f-b1de-f4a869a79c59/bpqs_6_step4.png)
...
![Godot Engine features page](try-different-things/attachments/godot.png)
...
<Tweet id="https://twitter.com/Faraaz98/status/1567601173276008450" />
...
![HTML5UP](try-different-things/attachments/html5up.png)
...
<video controls width="640" height="360">
  <source src="https://d2biiyjlsh52uh.cloudfront.net/rails/rails-8-demo.mp4" type="video/mp4" />
...
![Tisp blog post](try-different-things/attachments/tisp.png)
...
![Build Shit](try-different-things/attachments/build-shit.png)
