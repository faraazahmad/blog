...
function CaseNote() {
  return (
    <div
      className="flex h-80 flex-col gap-0 overflow-hidden pt-2 pr-4 pb-2 pl-10"
      style={{
    ...
    >
      ...
      <p className="-rotate-10 text-center leading-[26px] text-lg">
        suspect: <br/><span className="leading-[26px] underline decoration-red-600/60">deferred writeback error</span>
      </p>
      <p className="leading-[26px] text-sm">
        still at large. blamed tx 102. <br/><span className="leading-[26px] text-red-700">never tx 101.</span>
      </p>
      <p className="-mt-2 leading-[26px] text-sm">
        motive: everyone assumed <br/><span className="leading-[26px] underline decoration-red-600/60">fsync() == durable</span>
      </p>
      <p className="-mt-2 leading-[26px] text-sm">
        postgres verdict: <br/><span className="leading-[26px] font-bold">PANIC on failure.</span>
      </p>
    </div>
  )
}
